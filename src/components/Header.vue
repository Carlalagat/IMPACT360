  ...
  <div :class="['header', { 'header--scrolled': isScrolled }]">
    ...
    <nav class="desktop-nav">
      <ul>
        ...
        <li><router-link to="/I3Launchpad">I3 LAUNCHPAD</router-link></li>
    ...
    <div :class="['mobile-menu', { 'mobile-menu--open': mobileMenuOpen }]">
      <ul>
        ...
        <li><router-link to="/I3Launchpad" @click="closeMobileMenu">I3 LAUNCHPAD</router-link></li>
        <li><router-link to="#" @click="closeMobileMenu">Blog</router-link></li>
